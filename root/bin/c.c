// c -- c compiler
//
// for Operating Systems Course in Tsinghua University
//
...
//
// Written by Robert Swierczek, Chenrui Wang, Yu Chen
...
enum {
    ...
    BSS_TAG   =  0x10000000, // tag for patching global offsets 256M
};
...
void emg(int i, int c) { if (c < BSS_TAG) *pdata++ = ip; else { *pbss++ = ip; c -= BSS_TAG; } emi(i, c); } // inited global in pdata, uninited global in pbss
