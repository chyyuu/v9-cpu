...
enum {
	...
	SECSIZE = PAGE, 	  // disk sector size 4KB
	STACKSZ = PAGE,   // user stack size (4KB)
	UVIRSZ  = PAGE*8,     // user virt mem space size
	UPHYSZ  = PAGE*4,     // user phy mem space size
};
